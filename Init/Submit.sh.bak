#!/bin/bash
#SBATCH -o /work/bm1164/m300832/ContinentalSetup/Init/Logs/SLURM_job.%j.%N.out
#SBATCH -e /work/bm1164/m300832/ContinentalSetup/Init/Logs/SLURM_job.%j.%N.err
#SBATCH -D /work/bm1164/m300832/ContinentalSetup/Init/
#SBATCH -J Init
#SBATCH --get-user-env
